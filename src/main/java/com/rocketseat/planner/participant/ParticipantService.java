...
public class ParticipantService {
    ...
    public void registerParticipantsToEvent(List<String> participantToInvoice, Trip trip){
        List<Participant> participants = participantToInvoice.stream().map(email -> new Participant(email, trip)).toList();
